...
})({"lxM36":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "368ebb0908c8ad9a";
"use strict";
...
},{}],"dNW0w":[function(require,module,exports,__globalThis) {
...
function addMessages(responseText) {
    ...
    const messages = lines.filter((line)=>line.length > 1).map((j)=>JSON.parse(j));
    for (const message of messages){
        ...
        msgDiv.innerHTML = (0, _marked.marked).parse(content);
    }
    window.scrollTo({
...
},{"marked":"4duqf"}],"4duqf":[function(require,module,exports,__globalThis) {
/**
...
},{}]},["lxM36","dNW0w"], "dNW0w", "parcelRequire94c2")

//# sourceMappingURL=chat_app.js.map
